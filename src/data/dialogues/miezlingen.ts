...
export const MIEZLINGEN_DIALOGUES: Record<string, DialogueNode> = {
  ...
  hetta_glocke_angebot: {
    ...
    lines: [
      ...
      { speaker: 'oma_hetta', text: 'Guck in der alten Scheune am Dorfrand. Da liegt seit Jahren Zeug, das niemand vermisst.' },
    ],
    effects: [{ startQuest: 'q_glocke' }, { giveItem: 'scheunenschluessel' }],
  },
  ...
  tobb_nebel: {
    ...
    effects: [
      { setFlag: 'kapitel_2' },
      { advanceQuest: 'q_hauptquest_1', step: 2 },
