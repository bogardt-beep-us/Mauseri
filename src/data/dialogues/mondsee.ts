...
export const MONDSEE_DIALOGUES: Record<string, DialogueNode> = {
  ...
  luna_nach_spiegel: {
    ...
    lines: [
      ...
      { speaker: 'seherin_luna', text: 'Nach Norden liegen die Schattenlande. Geh nicht allein.' },
      { speaker: 'pookie', text: 'Sie geht nicht allein. Ich bin dabei.', mood: 'happy' },
  ...
  luna_herz: {
    id: 'luna_herz',
    lines: [
      { speaker: 'seherin_luna', text: 'Du traegst es.', mood: 'surprised' },
      { speaker: 'seherin_luna', text: 'Und es hat dich noch nicht veraendert. Das ist bemerkenswert.' },
      { speaker: 'seherin_luna', text: 'Weisst du, warum es Nyxara veraendert hat und dich nicht?' },
      { speaker: 'mauseri', text: 'Nein.' },
      { speaker: 'seherin_luna', text: 'Weil sie es allein getragen hat.' },
